...
const useMagneticButtonRectVariantThree = (
  ...
  const update = (mx: number, my: number) =>
    Object.values(elements).forEach(value => value.updateElement(mx, my));

  const reset = () =>
    Object.values(elements).forEach(value => value.resetElement());
...
export default useMagneticButtonRectVariantThree;
