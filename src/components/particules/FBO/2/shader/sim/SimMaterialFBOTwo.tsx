...
import { getDonutsFBO } from "../../../utils/getDonutsFBO";

export default class SimMaterialFBOTwo extends ShaderMaterial {
  constructor(size: number) {
    const positionsTexture = new DataTexture(
      getDonutsFBO(size * size),
      size,
      size,
      RGBAFormat,
      FloatType
    ...
    void main() {
        ...
        pos.xy+=vec2(0.5);
        // pos = curlNoise(pos * uFrequency + uTime );
        // curlPos = curlNoise(curlPos * uFrequency );
        // curlPos += curlNoise(curlPos * uFrequency * 2.0) * 0.5;
        // curlPos += curlNoise(curlPos * uFrequency * 4.0) * 1.;
